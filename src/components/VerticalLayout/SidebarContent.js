          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/dashboard" className="waves-effect">
                <i className="ri-dashboard-line"></i><span className="badge rounded-pill bg-success float-end"></span>
            ...
            {/* <li> */}
              {/* <Link to="/#" className="has-arrow waves-effect"> */}
                {/* <i cl`assName="ri-map-pin-line"></i> */}
                {/* <span className="ms-1">{this.props.t('Maps')}</span> */}
              {/* </Link> */}
              {/* <ul className="sub-menu"> */}
                {/* <li><Link to="/google-maps">{this.props.t('Google Maps')}</Link></li> */}
                <li><Link to="/coverage-enhancement">{this.props.t('Coverage Enhancement')}</Link></li>
              {/* </ul> */}
            {/* </li> */}
            {/* <li>
